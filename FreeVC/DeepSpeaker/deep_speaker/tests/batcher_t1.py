...
from deep_speaker.batcher import (
    ...
    TripletBatcher,
    TripletBatcherSelectHardNegatives,
)
...
def main2():
    ...
    tpshn = TripletBatcherSelectHardNegatives(
        kx_train, ky_train, kx_test, ky_test, None
    )
...
def main():
    ...
    if select:
        ...
        batcher = TripletBatcherSelectHardNegatives(
            kc.kx_train, kc.ky_train, kc.kx_test, kc.ky_test, dsm
        )
    else:
